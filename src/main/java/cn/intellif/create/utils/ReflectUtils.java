...
public abstract class ReflectUtils {
    ...
    //缓存类的字段
    private static Map<String,List<Field>> cache = new ConcurrentHashMap<String,List<Field>>();

    //缓存类中id字段
    private static Map<String,Field> idsCache = new ConcurrentHashMap<String,Field>();
    ...
    public static Field getIdField(Class clazz){
        ...
        for(Field temp:fields){
            TableId id = temp.getAnnotation(TableId.class);
            if(id!=null){
